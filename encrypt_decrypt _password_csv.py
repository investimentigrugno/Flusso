...
st.set_page_config(
    page_title="🔐 CSV Password Decryptor",
    page_icon="🔐",
    layout="wide",
...
with st.sidebar:
    ...
    ### Sicurezza:
    ✅ **Decriptazione locale** - I dati non vengono inviati a server esterni  
    ✅ **Nessun salvataggio** - I file vengono elaborati solo in memoria  
    ✅ **Compatibile** con Google Apps Script Password Manager  
...
<div style='text-align: center; color: #666;'>
    ...
    <p><small>Compatibile con Google Apps Script Password Manager</small></p>
</div>
""", unsafe_allow_html=True)

# Warning finale sulla sicurezza
if uploaded_file is not None or master_key:
    st.sidebar.markdown("---")
    st.sidebar.error("""
    🔒 **PROMEMORIA SICUREZZA:**

    - Questa app funziona completamente nel tuo browser
    - I dati non vengono inviati a server esterni
    - Chiudi la scheda quando hai finito
    - Non lasciare file decriptati aperti
    """)
